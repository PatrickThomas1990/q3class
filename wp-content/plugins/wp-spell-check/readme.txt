...
WordPress spell check, WordPress Grammar Check, Find SEO Problems, WordPress Proofreader, Find broken code, find broken HTML, find Broken shortcode, website spelling, Improve SEO, Spell Check, Spell Checker, grammar checker, WordPress SEO Problems, spelling errors, spelling mistakes, spelling report, fix spelling, WP Spell Check, spellcheck, spellchecker, WordPress spelling, Find Lorem Ipsum, Lorem Ipsum, WooCommerce, WP eCommerce, broken HTML, broken plugins, Proofreader, Proofreading, opendyslexic, dyslexic, dyslexia, medical spell check
...
*    Quickly and easily create a professional image for your webiste visitors. An image your customers want to invest in on a daily basis
...
*   Have a disability that makes reading problematic (**dyslexia**)
*   Are developers who do not write the content but are nonetheless responsible for proper spellings!
*   SEO and web agencies trying to find a way to improve Clients' websites and improbe their processes 
...
Yes, it does. In version 6.x we added the ability to check your WordPress website or spelling errors. 
...
The plugin runs in the background of your WordPress website and scans all parts of your website for spelling & grammar errors.
...
We do Not offer support for installation of the product on your website. With the purchase of the plugin, you will receive one year of updates to the plugin. We will be releasing updates with added features and improvements.
...
This is an error that can happen as a result of insufficient PHP memory on the server.  To confirm this, check your server's PHP error log.  If a scan is not completing due to memory limits, To stop it, click on Stop Scan 
...
Copyright: © 2018 [Persyo Inc](http://www.persyo.com/) (coded in CANADA)
...
- Added new feature to provide support for #OpenDyslexic font designed for people with Dyslexia

- Other bug fixes and improvements

- Added over 65000, first/last names to the spell check list

- Added funtionality to find the number of Broken Codes on your website
