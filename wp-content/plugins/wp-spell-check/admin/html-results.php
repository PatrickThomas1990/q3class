		...
		<div class="wrap wpsc-table">
			...
			<form action="<?php echo admin_url('admin.php'); ?>" method='GET'>
				...
				<div style="padding: 5px; background: white; font-size: 12px;">
					...
					<?php if (!$ent_included) echo "<h3 class='sc-message' style='color: rgb(225, 0, 0);'><a href='https://www.wpspellcheck.com/purchase-options' target='_blank'>Upgrade</a> to scan all parts of your website.</h3>"; ?>
				</div>
			</form>
...
<?php } ?>
	 ...
	 ?>
		...
		<?php } else { ?>
			...
			<h3><a href="https://www.wpspellcheck.com/purchase-options/" target="_blank">Upgrade to pro</a> to find broken HTML and Shortcodes on your website.</h3>
