	...
	<div class="wrap wpsc-table">
		<h2><a href="admin.php?page=wp-spellcheck-seo.php"><img src="<?php echo plugin_dir_url( __FILE__ ) . '../images/logo.png'; ?>" alt="WP Spell Check" /></a> <span style="position: relative; top: -15px;">Scan Results</span></h2>
			<div class="wpsc-scan-nav-bar">
				...
				<a href="#empty-fields" id="wpsc-empty-fields" class="selected" name="wpsc-empty-fields">SEO Opportunities</a>
			...
			<form action="<?php echo admin_url('admin.php'); ?>" method='GET'>
				...
				<?php if (!$ent_included) {
					if ($empty_count > 0 && $empty_words > 0) {
						echo "<h3 class='sc-message' style='color: rgb(225, 0, 0);'>" . $empty_words . " Errors were found on other parts of your website. <a href='https://www.wpspellcheck.com/purchase-options' target='_blank'>Upgrade</a> to find and fix all errors.</h3>";
					} else {
